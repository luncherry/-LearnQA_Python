...
# 1. Запрос любого типа без параметра method (GET без method)
...
# 2. Запрос не из списка (например, HEAD)
...
# 3. Запрос с правильным значением method (GET с method=GET)
...
# 4. Цикл по всем реальным методам и всем возможным значениям method
...
for real_method in http_methods:
    for param_method in method_values:
        ...
        # Используем обычную стрелку из ASCII (->) вместо юникодной
